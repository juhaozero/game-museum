    ...
    >
      <div className="game-box-shadow relative">
        ...
        >
          ...
          <div
            aria-hidden
            className="relative w-2.5 shrink-0 overflow-hidden bg-gradient-to-b from-black/40 via-black/22 to-black/45"
          >
            <div className="game-box-spine-sheen absolute inset-x-0 top-0 h-1/2 bg-gradient-to-b from-white/35 to-transparent" />
          </div>
